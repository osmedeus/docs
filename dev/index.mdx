...
<Columns cols={2}>
  <Card title="Get started" icon="text-align-start" href="/getting-started/getting-started">
    Run your first workflow in 5 minutes
  </Card>
  <Card title="Installation"  icon="text-align-start" href="/getting-started/installation">
