...
|----------|-------------|
| `{{TargetType}}` | `"url"` |
| `{{TargetBaseURL}}` | Base URL (scheme + host + port) |
| `{{TargetRootURL}}` | Root URL (scheme + host + port) |
| `{{TargetHostname}}` | Full hostname |
| `{{TargetRootDomain}}` | Root domain extracted from hostname |
| `{{TargetHost}}` | Host (hostname + port) |
| `{{TargetPort}}` | Port number |
| `{{TargetPath}}` | URL path component |
| `{{TargetFileExt}}` | File extension if present |
| `{{TargetScheme}}` | HTTP scheme (http/https) |
| `{{TargetStatusCode}}` | HTTP status code (if reachable) |
| `{{TargetContentLength}}` | Content length of response |
...
|----------|-------------|
| `{{TargetType}}` | `"domain"` |
| `{{TargetRootDomain}}` | Root domain |
| `{{TargetIsWildcard}}` | Boolean indicating wildcard domain |
| `{{TargetResolvedIP}}` | Resolved IP address (if DNS succeeds) |
...
|----------|-------------|
| `{{TargetType}}` | `"ip"` |
| `{{TargetRootDomain}}` | Same as original target |
