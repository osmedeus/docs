---
title: "Notification and CDN Configuration"
description: "This guide covers advanced configuration options including notification and CDN setup"
icon: "bells"
---
...
verify your setup by sending a sample message with utility function `osmedeus eval 'notify_telegram("**hola** osmedeus from cli")'`
  ...
  <Frame caption="Notification Functions">
    <img src="/images/noti/noti-funcs.png" alt="Notification Functions" />
  </Frame>
...
<Frame caption="CDN Functions">
  <img src="/images/noti/cdn-funcs.png" alt="CDN Functions" />
</Frame>
