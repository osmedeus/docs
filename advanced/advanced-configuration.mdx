...
Configure cloud storage for result uploads.
...
**Event Types:**
- `workflow_completed` - Scan finished successfully
- `workflow_failed` - Scan failed
- `workflow_cancelled` - Scan was cancelled
...
- name: notify-completion
  type: function
  function: 'notifyTelegram("Scan completed for {{Target}}")'

- name: send-webhook
  type: function
  function: 'notifyWebhook("Scan done: {{Target}}")'
```
